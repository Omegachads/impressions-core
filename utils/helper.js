...
class GasLogger {
  ...
  addEstimate = (estimate) => {
    this.totalGas.add(estimate);
  };

  printEstimate = (gwei = "100") => {
    gwei = gwei.toString();
    console.log("----- Gas ESTIMATE -----");
    console.log("⛽ Gas Consumed: ", this.totalGas.toString(), "wei");
    console.log("⛽ Gas Price: ", gwei, "gwei");
    console.log(
      "Ξ Cost: ",
      utils.formatEther(
        this.totalGas.mul(ethers.utils.parseUnits(gwei, "gwei"))
      ),
      "Ξ"
    );
    console.log();
